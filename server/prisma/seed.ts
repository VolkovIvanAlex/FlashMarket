...
async function main() {
  ...
  // Add participations to Live FCFS Drop (queueIndex is meaningful here)
  ...
  // Add participations + bids to Live Auction Drop
  ...
  // Add participation to Closed FCFS Drop
  ...
  // Add participation + bid to Closed Auction Drop
